                    ...
                    <div class="xl:col-span-2 space-y-8 sm:space-y-10">
                        ...
                        <div class="rounded-2xl overflow-hidden shadow-lg border border-[#D4A569]/30 w-full relative group bg-[#2C1A0E]">
                            <div class="aspect-video w-full overflow-hidden">
                                <img src="{{ $lokasi->gambar ? asset('storage/image_lokasi/' . $lokasi->gambar) : 'https://images.unsplash.com/photo-1556761175-b413da4baf72?q=80&w=1200&auto=format&fit=crop' }}" 
