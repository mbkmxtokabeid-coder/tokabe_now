                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.faq.update', $faq->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="question_id" name="question_id" value="{{ old('question_id', $faq->question_id) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="answer_id" name="answer_id" rows="4" required>{{ old('answer_id', $faq->answer_id) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary mt-3"><i class="feather icon-save"></i> Update FAQ</button>
